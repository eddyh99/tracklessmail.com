            ...
            <div class="col-10 col-sm-8 col-md-6 col-lg-5 box-form">
                <form class="form-login-freedy d-flex align-items-start flex-column" style="height: 100%;" method="POST"
                    ...
                    <div class="col-12 alert alert-danger alert-dismissible fade show" role="alert">
                        <span class="notif-login f-poppins"><?= $_SESSION["message"] ?></span>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <?php } ?>
                    <div class="col-12 mb-4 text-center">
                        <span class="my-3 title f-poppins">LOGIN CPANEL</span>
                        <img src="<?= base_url(); ?>assets/images/tracklessbank/trackless.png" alt="">
                    </div>
