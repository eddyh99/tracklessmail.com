...
<head>
    ...
    <!-- Favicons -->
    <link href="<?= base_url() ?>assets/images/tracklessbank/trackless.png" rel="icon">
    <link href="<?= base_url() ?>assets/images/tracklessbank/trackless.png" rel="apple-touch-icon">
