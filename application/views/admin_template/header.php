...
<head>
    ...
    <!-- Favicons -->
    <link href="<?= base_url() ?>assets/images/tracklessbank/logo-polos.png" rel="icon">
    <link href="<?= base_url() ?>assets/images/tracklessbank/logo-polos.png" rel="apple-touch-icon">
