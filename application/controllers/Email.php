...
class Email extends CI_Controller
{
	...
	public function createemail()
	{
		...
		$this->session->set_flashdata('success', "Thank you for registering Anonymous Email, You need activate the email before use it. <a href='" . base_url() . "email/activate?key=" . urlencode(base64_encode($encrypted)) . "'>link</a>");
		redirect(base_url() . "auth/index");
	}
